...
exports.getMe = async (req, res) => {
    try {
        ...
        const [data] = await db.query(q, [myId]);
...
exports.updateUser = async (req, res) => {
    try {
        ...
        const [data] = await db.query(checkQuery, [id]);
        ...
        const [emailData] = await db.query(emailCheckQuery, [emailToCheck, id]);
        ...
        await db.query(userUpdateQuery, [finalPassword, id]);
        ...
        await db.query(customerUpdateQuery, customerValues);
